...
Original file is located at
    https://colab.research.google.com/drive/1PzGkUNC1RqOhQmqGlQHRCgLjDK7GQEBQ
"""


# -*- coding: utf-8 -*-
"""bot base - Hybrid PTB & Telethon with Bot 3 Responses"""
...
# Tarik data dari Secrets
try:
    BOT_TOKEN = userdata.get('BOT_TOKEN')
    CHANNEL_ID = userdata.get('CHANNEL_ID')
    GROUP_ID_DISKUSI = int(userdata.get('GROUP_ID_DISKUSI'))
    ADMIN_GROUP_ID = int(userdata.get('ADMIN_GROUP_ID'))
    LOG_GROUP_ID = int(userdata.get('LOG_GROUP_ID'))
    SUPABASE_URL = userdata.get('SUPABASE_URL')
    SUPABASE_KEY = userdata.get('SUPABASE_KEY')

    # === KREDENSIAL USERBOT TELETHON ===
    USERBOT_API_ID = int(userdata.get('USERBOT_API_ID'))
    USERBOT_API_HASH = userdata.get('USERBOT_API_HASH')
    USERBOT_PHONE = userdata.get('USERBOT_PHONE')
